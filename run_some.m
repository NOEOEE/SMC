...
runSummary = table(summaryNames, summaryStatus, summaryFigureCount, summaryTableCount, ...
    ...
    'VariableNames', {'Demo', 'Status', 'FigureCount', 'TableCount', 'ElapsedSec', 'OutputDir', 'ErrorMessage'});
...
try
    ...
    if strcmpi(cfg.logMode, 'diary')
        ...
        capturedText = local_run_with_evalc(tempScriptPath);
